...
contract_adress = w3.toChecksumAddress("0x8d24c9891714DF4f55c3d665d9da617bae940167")

contract = w3.eth.contract(address = contract_adress , abi = contract_abi)

_hash = hashlib.sha256(bytes(32000)).digest()

valid = contract.functions.initializationContract(import_log()['adresseProprietaire'],_hash, 3000).call()
print(valid)
print(" ")
